...
const Registration = () => {
    ...
    return (
        <>
            <div className=" flex h-full bg-red-300 bg-no-repeat bg-center bg-cover backdrop-filter p-5 backdrop-blur-sm bg-[url('https://raw.githubusercontent.com/salekmasudparvez/sm-cash-client/main/src/assets/singupBanner.png')]">

                <div className="max-w-md mx-auto  w-full  p-5 space-y-3 rounded-xl bg-white">
