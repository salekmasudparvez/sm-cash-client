...
const Login = () => {
    ...
    return (
        <div className="lg:bg-white  bg-[url('https://raw.githubusercontent.com/salekmasudparvez/sm-cash-client/main/src/assets/LoginBanner.png')] bg-no-repeat bg-center bg-cover flex h-full ">
            <div className='h-full min-h-screen lg:p-0 p-5 backdrop-blur-3xl lg:bg-white  w-full flex justify-center items-center'>
                ...
                <div className=" max-w-md mx-auto lg:bg-white lg:w-1/3 p-5 space-y-4 rounded-xl ">
                    <h1 className="text-2xl max-w-md mx-auto font-bold text-center text-[#FE1280]">Login now</h1>
                    <form onSubmit={handleLogin} className="space-y-2 max-w-md mx-auto">
                        <div className="space-y-1 text-sm">
                            <label htmlFor="email" className="block text-white">Enter (email/phone number)</label>
                        ...
                        <div className="space-y-1 text-sm">
                            <label htmlFor="pin" className="block text-white">5-digit PIN</label>
                    ...
                    <p className="text-xs text-center sm:px-6 text-gray-600 max-w-md mx-auto">Don't have any account ?
